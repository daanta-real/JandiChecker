...
public class SlashMenu {
    ...
    public static List<CommandData> getMenusList() {
        ...
        cmdList.add(Commands.slash(JDAController.CMD_TRANSLATE_KR_TO_EN, "한글 문장을 영어로 번역합니다.")
                .addOption(OptionType.STRING, "option", "영문으로 번역할 한글 내용을 입력하세요.", true));
        cmdList.add(Commands.slash(JDAController.CMD_TRANSLATE_EN_TO_KR, "영어 문장을 한글로 번역합니다.")
